...
function Add_EWD_FEUP_Scripts() {
	...
	if (isset($_GET['page']) && $_GET['page'] == 'EWD-FEUP-options') {
		...
		wp_localize_script( 'password-strength', 'ajax_translations', $Translation_Array );
...
function EWD_FEUP_Add_FrontEnd_Scripts() {
	// Turn off the tracking feature - as it is not wanted!!!
...
function EWD_EUP_Get_All_Fields() {
