				...
				switch ($_GET['Action']) {
    				case "EWD_FEUP_AddUser":
						...
						case "EWD_FEUP_MassDeleteFields":
								...
								break;
						case "EWD_FEUP_AddPayment":
						case "EWD_FEUP_EditPayment":
								$feup_message = Add_Edit_Payment();
								break;
						case "EWD_FEUP_DeletePayment":
								$feup_message = Delete_EWD_FEUP_Payment($_GET['Payment_ID']);
								break;
