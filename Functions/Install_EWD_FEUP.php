...
function Install_EWD_FEUP() {
	...
	if (get_option("EWD_FEUP_Sign_Up_Email") == "") {update_option("EWD_FEUP_Sign_Up_Email", "No");}
	...
	if (get_option("EWD_FEUP_Email_On_Admin_Approval") == "") {update_option("EWD_FEUP_Email_On_Admin_Approval", "No");}
	if (get_option("EWD_FEUP_Admin_Email_On_Registration") == "") {update_option("EWD_FEUP_Admin_Email_On_Registration", "No");}
