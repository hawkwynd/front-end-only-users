...
For further information and purchasing options, please visit our <strong><a href="http://www.etoilewebdesign.com/plugins/front-end-only-users/">WordPress user management</a></strong> plugin homepage.
...
8. The "Basic" section of the "Options" admin screen
9. The "Premium" section of the "Options" admin screen
10. The "Payment" section of the "Options" admin screen, showing the customizable options
11. The "Commerce" section of the "Options" admin screen
12. The "Labelling" section of the "Options" admin screen
13. The "Styling" section of the "Options" admin screen.
14. The "Payments" admin screen, showing recent payments, amount paid, next payment date and discount code used
