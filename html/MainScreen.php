<div class="EWD_FEUP_Menu">
    <h2 class="nav-tab-wrapper">
        <a id="Dashboard_Menu" class="MenuTab nav-tab <?php if ($Display_Page == '' or $Display_Page == 'Dashboard') {
            echo 'nav-tab-active';
        } ?>" onclick="ShowTab('Dashboard');"><?php _e("Dashboard", "EWD_FEUP"); ?></a>
        <a id="Users_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Users') {
            echo 'nav-tab-active';
        } ?>" onclick="ShowTab('Users');"><?php _e("Users", "EWD_FEUP"); ?></a>
        ...
        <a id="Fields_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Field') {
            echo 'nav-tab-active';
        } ?>" onclick="ShowTab('Fields');"><?php _e("Fields", "EWD_FEUP"); ?></a>
        <a id="Levels_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Levels') {
            echo 'nav-tab-active';
        } ?>" onclick="ShowTab('Levels');"><?php _e("Levels", "EWD_FEUP"); ?></a>
        ...
        <!-- <a id="Payments_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Payments') {echo 'nav-tab-active';}?>" onclick="ShowTab('Payments');"><?php _e("Payments", "EWD_FEUP"); ?></a> -->
    </h2>
</div>
...
<div class="OptionTab <?php if ($Display_Page == "" or $Display_Page == 'Dashboard') {
    echo 'ActiveTab';
} else {
    echo 'HiddenTab';
} ?>" id="Dashboard">
...
<div class="OptionTab <?php if ($Display_Page == 'Users' or $Display_Page == 'User') {
    echo 'ActiveTab';
} else {
    echo 'HiddenTab';
} ?>" id="Users">
...
-->
<div class="OptionTab <?php if ($Display_Page == 'Fields' or $Display_Page == 'Field') {
    echo 'ActiveTab';
} else {
    echo 'HiddenTab';
} ?>" id="Fields">
...
<div class="OptionTab <?php if ($Display_Page == 'Levels' or $Display_Page == 'Level') {
    echo 'ActiveTab';
} else {
    echo 'HiddenTab';
} ?>" id="Levels">
