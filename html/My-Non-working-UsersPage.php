        ...
        <div class="form-wrap">
            ...
            <form id="addtag" method="post"
                ...
                <div class="form-field form-required">
                       ...
                       ?>
                        ...
                        <?php } elseif ($Field->Field_Type == "radio") {
                             ...
                             $dataPak .= "<div style='line-height:25px;display:block;font-size:11px;'><span>" . strtoupper(  $Field->Field_Name ) . "</span>";
                             foreach ($Options as $Option) {
                             // Default setting is "NO" for all radio options
                             $dataPak .='<div style="float:right;width:auto;padding:0 2px;"><input type="radio" class="ewd-admin-small-input" name="' .$Field->Field_Name . '" value="' . $Option . '">' . $Option ."</div>";
                             } //foreach
                ...
                <?php
                   ...
                   // echo "<h2>New User Permissions</h2>";
                   // echo '<div class="form-field form-required">'. $dataPak ."</div>";
                ?>
                <p class="submit">
                    <input type="submit" name="submit" id="submit" class="button-primary" value="<?php _e('Add New User', 'EWD_FEUP') ?>"/>
                </p>
            </form>
        </div><!-- form-wrap -->
        </div><!-- col-wrap -->
