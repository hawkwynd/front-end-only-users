...
function Insert_User_Profile($atts) {
	...
	$ReturnString = "";
	if (!isset($UserData)) {return $feup_Label_Select_Valid_Profile;}
	...
	if ($feup_Label_Select_Valid_Profile == "") {$feup_Label_Select_Valid_Profile = __("Please select a valid user profile", 'EWD_FEUP');}
