...
function Privilege_Level($atts, $content = null) {
	...
	if ($feup_Label_Nonlogged_Message == "") {$feup_Label_Nonlogged_Message = __("This content is only for non-logged in users", 'EWD_FEUP');}
	$feup_Label_Low_Account_Level_Message =  get_option("EWD_FEUP_Label_Low_Account_Level_Message");
	if ($feup_Label_Low_Account_Level_Message == "") {$feup_Label_Low_Account_Level_Message =  __("Sorry, your account level is too low to access this content.", 'EWD_FEUP');}
	$feup_Label_High_Account_Level_Message =  get_option("EWD_FEUP_Label_High_Account_Level_Message");
	if ($feup_Label_High_Account_Level_Message == "") {$feup_Label_High_Account_Level_Message = __("Sorry, your account level is too high to access this content.", 'EWD_FEUP');}
	$feup_Label_Wrong_Account_Level_Message =  get_option("EWD_FEUP_Label_Wrong_Account_Level_Message");
	if ($feup_Label_Wrong_Account_Level_Message == "") {$feup_Label_Wrong_Account_Level_Message = __("Sorry, your account isn't the correct level to access this content.", 'EWD_FEUP');}
